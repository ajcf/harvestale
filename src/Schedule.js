    ...
    <Box sx={{ flexGrow: 1 }}>
      ...
      <ScheduleDay
        ...
        events={[
          ...
          { time: "11:50", label: "Second Stand", description:
          <Grid container>
            <Grid item xs={12} sm={6} className="detail">
              Jugger Meadow tour
            </Grid>
            <Grid item xs={12} sm={6} className="detail">
              Glacial Potholes<br/>
              Park at the <a href="https://maps.app.goo.gl/E1ysuuaSgDDzQhpA9">Trolley Museum</a>
            </Grid>
            <Grid item xs={12} sm={6} className="detail additional-row">
              Wake Robin tour
            </Grid>
          ...
          { time: "3p", label: "Wilder Farm Sampler", description:
            <a href="https://maps.app.goo.gl/6Z1xKSu4GZjZR24S6">Wilder Homestead Museum</a>},
